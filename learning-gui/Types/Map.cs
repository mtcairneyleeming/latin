...
namespace learning_gui.Types
{
    public class Map<T1, T2> : IEnumerable<KeyValuePair<T1, T2>>
    {
        ...
        {
            return Forward.TryGetValue(t1, out t2);
        }

        public bool TryGetValue(T2 t2, out T1 t1)
        {
            return Reverse.TryGetValue(t2, out t1);
        }
        ...
        public class Indexer<T3, T4>
        {
            ...
            public bool TryGetValue(T3 t3, out T4 t4)
            {
                return _dictionary.TryGetValue(t3, out t4);
            }
        }
    }
}